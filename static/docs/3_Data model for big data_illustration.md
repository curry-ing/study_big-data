...
**Node**: 공용체, **Edge**: 구조체, **Property**: 이들의 조합으로 구성 
...
- 현재는 타임스탬프만을 가지고 있으나, 필요시 디버깅 정보나 데이터의 출처 포함 가능
...
- **필드 삭제시 해당 id 재사용 금지**
  ...
  - 삭제된 ID를 재사용시 스리프트는 오래된 데이터를 새로운 필드로 역렬화 시도  
...
#### 예제> `SuperWebAnalytics.com`스키마의 개선
